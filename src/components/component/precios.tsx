...
export function Precios() {
  return (
    <section className="min-h-screen w-full py-12 bg-gradient-to-b from-gray-50 to-purple-400 dark:from-zinc-900 dark:to-zinc-800 flex items-center justify-center">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-3 md:gap-8">
          ...
          <div className="relative flex flex-col p-6 bg-white shadow-lg rounded-lg dark:bg-zinc-850 justify-between border border-gray-200 border-purple-500 dark:border-gray-800">
            <div className="px-3 py-1 text-sm text-white bg-gradient-to-r from-pink-500 to-green-500 rounded-full inline-block absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              Popular
            </div>
            <div>
